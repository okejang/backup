 ...
 <div id="login">
  ...
  <div class="col-md-12">
       ...
       <div class="panel-body">
          <div class="page-hd">
            <center><img src="<?php echo base_url();?>asset/home/images/logoweb.png" style="height:150px"></center>
         <h3 style="text-align:center">Login Mentor RYC</h3>
      </div>
      <form action="<?php echo base_url()."loginmentor/ceklogin"?>" method="post" accept-charset="utf-8" role="form">
